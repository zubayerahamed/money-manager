<x-setup-layout pageTitle="Requirements">
    <div class="card-body">
        <h6 class="text-center">Server Requirements & Permissions</h6>
    ...
    <div class="card-footer">
        <a href="{{ route('setup.welcome') }}" class="btn btn-sm btn-light"><i class="ph-arrow-fat-lines-left me-2"></i> Previous</a>
