...
Route::group(['middleware' => ['auth', 'setup']], function () {
    ...
    Route::group([
        ...
        Route::get('/details/monthlygrouped/{itemid}/{transactiontype}/{year}', [TrackingHistoryController::class, 'showItemWiseMonthlyGroupedTotalTransactions'])->name('monthlygrouped');
